          ...
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] py-1 text-muted-foreground md:text-xl">
                Full Stack Developer from the United States. Firm believer in user privacy and
                innovation. Currently residing in Ohio, learning about Cybersecurity and Network
                Defense. Just living life.
              </p>
            </div>
          ...
          <Card className="overflow-hidden border-0 bg-transparent shadow-none">
            <div className="space-y-3 px-6 pt-6 text-center">
              ...
              <p className="text-sm text-muted-foreground md:text-base">
                The softwares and tools I use to build my projects, websites, tools, and everything
                in between.
              </p>
            </div>
