...
export const metadata: Metadata = {
  title: "Certifications | DIBSTER Portfolio",
    ...
    <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-16 pt-24">
      ...
      <div className="grid gap-y-6 gap-x-4 md:grid-cols-2 lg:grid-cols-3">
        {certifications.map((cert) => (
          <div key={cert.link} className="flex justify-center">
            <BackgroundGradient className="rounded-[22px] w-[320px] sm:w-[380px] p-4 sm:p-6 bg-white dark:bg-zinc-900 h-full">
              <div className="flex flex-col h-full">
                ...
                <div className="mt-auto">
                  <Button size="sm" asChild className="bg-black text-white hover:bg-zinc-800">
                    <Link
                      href={cert.link}
                      target="_blank"
                      rel="noopener noreferrer"
