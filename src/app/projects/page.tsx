...
export const metadata: Metadata = {
  title: "Projects | DIBSTER Portfolio",
...
const projects: Project[] = [
  {
    title: "Desert Storm",
    description:
      "A unified dashboard for hosting companies to manage Pterodactyl, VirtFusion, Paymenter, Discord, and more.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "A Discord bot that integrates with the Pterodactyl API for account and server management.",
    longDescription:
      "This DanBot Hosting project provides Discord-based workflows for user creation, server provisioning, and ongoing Pterodactyl management. I maintain this project and continue supporting its improvements and reliability.",
    ...
    urls: [
      {
        ...
        href: "https://github.com/DanBot-Hosting/Pterodactyl-Discord-Bot",
      },
    ],
  },
  {
    ...
    longDescription:
      "The LocalCert dashboard is the main interactive website for LocalCert subdomain management. I built the initial first iteration and design of this dashboard to establish the foundation for the user experience and interface direction.",
    ...
    urls: [
      {
        label: "GitHub Repository",
        href: "https://github.com/getlocalcert/dashboard",
      },
    ],
  },
  {
    ...
    longDescription:
      "The is-a.dev register repository powers the workflow for claiming sweet-looking .is-a.dev subdomains and maintaining related service processes. I maintain this project and help keep the registration flow reliable and contributor-friendly.",
    ...
    otherItems: [
      {
        ...
        href: "https://discord.gg/is-a-dev-830872854677422150",
      },
    ],
  },
];
...
function ProjectCard({ project }: { project: Project }) {
  const hasVisibleHref = (href?: string) => Boolean(href && href.trim() && href.trim() !== "#");
  const isVisibleItem = (item?: ProjectLink) =>
    Boolean(item?.label && hasVisibleHref(item?.href));
  const urls = (project.urls ?? []).filter(isVisibleItem);
  const blogs = (project.blogs ?? []).filter(isVisibleItem);
  const otherItems = (project.otherItems ?? []).filter(isVisibleItem);
      ...
      <CardContent className="flex-grow">
        ...
        {urls.length > 0 ? (
          <div className="mt-4">
            ...
            <div className="flex flex-wrap gap-2">
              {urls.map((item) => (
                <Button key={`${item.href}-${item.label}`} variant="outline" size="sm" asChild>
